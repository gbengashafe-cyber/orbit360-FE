...
const ALL_PERMISSIONS = [
  ...
  "approve_all_requests", "request_staff_movement", "manage_vendors", "manage_employees",
  "approve_staff_movement", "approve_training_requests", "manage_complaints", "manage_recruitment",
  "audit_expenses", "manage_expenses", "view_financial_reports", "manage_own_projects", "manage_teams",
  "access_self_service", "approve_expenses_level_2",
  // New banking-specific permissions
  "approve_expenses_level_1", "view_branch_data", "manage_branch_staff", "process_loan_applications",
  "view_client_financials", "perform_customer_transactions", "audit_transactions", "manage_it_assets",
  "provide_technical_support", "manage_credit_risk", "manage_customer_relationships",
  "handle_customer_inquiries", "manage_marketing_campaigns", "conduct_internal_audits"
];
    ...
    <div className="min-h-screen bg-red-50 flex items-center justify-center p-4">
      <div className="text-center bg-white p-10 rounded-lg shadow-lg max-w-md">
        ...
        <p className="text-gray-600 mb-6">
          Your access to the Orbit360 platform has been temporarily suspended. Please contact your administrator or the HR department for further information.
        </p>
    ...
    const checkAuthAndPromoteAdmin = async () => {
      try {
        ...
        if (user.email === "gbengashafe@gmail.com") {
          const isFullyAdmin = user.role === "admin" &&
                               user.job_role === "admin" &&
