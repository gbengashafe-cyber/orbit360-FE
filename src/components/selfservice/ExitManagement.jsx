                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <p className="text-sm text-gray-600">
                            A complete handover ensures a smooth transition and helps maintain continuity of work. Your supervisor will guide you through the remaining steps.
                        </p>
                    </div>
