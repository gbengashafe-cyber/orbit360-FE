...
import { ArrowRight, Briefcase, FolderArchive, Loader2, Star, Users2 } from 'lucide-react';
...
export default function HRDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      const [employees, jobs, reviews] = await Promise.all([Employee.list(), JobPosting.list(), PerformanceReview.list()]);
