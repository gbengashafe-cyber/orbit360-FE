...
import { AlertCircle, AreaChart, BarChart3, CheckCircle, Clock, Layers3, Loader2 } from 'lucide-react';
...
export default function Analytics() {
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true);
      try {
        const [projectsData, issuesData] = await Promise.all([Project.list('-created_date'), Issue.list()]);
